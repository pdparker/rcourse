...
- An element
- A container or object
- A function

## R basics (the boring bits) - Elements
'Classes' data can take include:
...
Containers come in the form of:
 ...
 - Vectors: 1 or more elements of the same class e.g. 1,2,3
 - Factors: character vector with 'special' properties "male", "female", "female"
 - List: 1 or more objects of any type 1,"A", TURE
...
## Functions to try
- max, min, range, summary, plot, hist
...
#read the data
myData <- read.spss("PISA2003.sav", to.data.frame = TRUE, use.value.labels = FALSE)
#Check it read in ok
dim(myData)
names(myData)[1:4]
